...
const NewsDetails=()=>(
        <div className='news-details-container'>
            <h1>News Details</h1>
            <ul className='details-container' type='none'>
                {articlesDetailsList.map(eachArticleDetails=>(
                    <li className='details-container' key={eachArticleDetails.id}>
                        <div>
                            <h1>{eachArticleDetails.title}</h1>
                            <p>{eachArticleDetails.summary}</p>
                            <p>{eachArticleDetails.content}</p>
                        </div>
                    </li>
                ))}
            </ul>
